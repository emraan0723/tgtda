    ...
    e.sessionTimeout = function (t) {
        ...
        function s(t, o) {
            clearTimeout(l.timer),
                "dialog" === t && o ? (l.timeLeft = Math.floor((d.redirAfter - d.warnAfter) / 1e3)) : "session" === t && o && (l.timeLeft = Math.floor(d.redirAfter / 1e3)),
                d.countdownBar && "dialog" === t
                    ? (l.percentLeft = Math.floor((l.timeLeft / ((d.redirAfter - d.warnAfter) / 1e3)) * 100))
                    : d.countdownBar && "session" === t && (l.percentLeft = Math.floor((l.timeLeft / (d.redirAfter / 1e3)) * 100));
        ...
        if ("function" != typeof d.onWarn) {
            ...
            e("body").append(
                '<div class="modal fade" id="session-timeout-dialog">               <div class="modal-dialog">                 <div class="modal-content">                   <div class="modal-header">                                          <h4 class="modal-title">' +
                    d.title +
                    '</h4>    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>               </div>                   <div class="modal-body">                     <p>' +
                    d.message +
                    "</p>                     " +
                    u +
                    "                     " +
            ...
            e(document).on("keyup mouseup mousemove touchend touchmove", function (t) {
                ...
                i(),
                    e("#session-timeout-dialog").length > 0 &&
                        ...
                        (e("#session-timeout-dialog").modal("hide"), e("body").removeClass("modal-open"), e("div.modal-backdrop").remove());
            });
        }
        var f = !1;
        i();
