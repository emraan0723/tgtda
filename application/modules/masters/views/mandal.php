                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card card-body">
                            <h6 class="card-title" style="margin-bottom: -27px;">Add mandal</h6>
                            <!-- Row -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-lg-3">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" maxlength="100" name="mandal_name" id="mandal_name_id_1"  class="form-control form-control-line alpha_s">
                                        <div class="valid-feedback" style="color: red">
                                      </div>
                ...
                <div class="row">
                   ...
                   <div class="col-md-12">
                        <div class="card card-body">
                           <div class="card">
                            <div class="card-body">
                                <h6 class="card-title">View Mandals</h6>
...
$(document).ready(function() {
      var url = "<?php echo base_url();?>"+"mandal_datatable";
    //datatables
    table = $('#mandal_datatable').DataTable({
...
<script>
     function mandalEdit(id)
      {
        var url = "<?php echo base_url();?>"+"edit_mandal";
        $.ajax({
            type:'POST',
            url: url,
            dataType:"html",
            data:{'mandal_id':id,"<?php echo $this->security->get_csrf_token_name();?>":"<?php echo $this->security->get_csrf_hash();?>"},
