                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card card-body">
                            <h6 class="card-title" style="margin-bottom: -27px;">Add city</h6>
                            <!-- Row -->

                            <?php //echo validation_errors(); ?>
                           <form id="frm_state_create_id" class="form-material mt-5 needs-validation" method="post" onsubmit="return  cityValidationForm('create');">
                            ...
                            <div class="row">
                                 ...
                                 <div class="col-sm-12 col-lg-3">
                                    <div class="form-group ">
                                        <label>Select Districts</label>
                                            <select class="form-control distictslist"  id="disticts_id_1" name="district_id">
                                                <option value=""></option>
                                ...
                                <div class="col-sm-12 col-lg-3">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" maxlength="100" name="city_name" id="city_name_id_1"  class="form-control form-control-line alpha_s">
                                        <div class="valid-feedback" style="color: red">
                                      </div>
                ...
                <div class="row">
                   ...
                   <div class="col-md-12">
                        <div class="card card-body">
                           <div class="card">
                            <div class="card-body">
                                <h6 class="card-title">View cities</h6>
...
$(document).ready(function() {
      var url = "<?php echo base_url();?>"+"city_datatable";
    //datatables
    table = $('#city_datatable').DataTable({ 
        ...
        "aoColumnDefs": [
         ...
         /*createdRow: function (row, data, dataIndex) {
            ...
            $(row).attr('title', "bvvvvvvv");
             $(row).attr('id', "tr_id_"+data.bv);
            $(row).attr('onclick', "addRowsssss('"+data.bv+"');");
        },
       */
    ...
    /*function addRowsssss(id)
    {
       
       if($("#dddddtrnew_"+id).val()==1)
       {
        $("#trnew_"+id).remove();
       }
       else
       {
          $("#tr_id_"+id).after('<tr id="trnew_'+id+'"><td colspan="7"><input type="hidden" id="dddddtrnew_'+id+'" value="1">bvvvvvv</td></tr>');
       }
...
<script>
     function cityEdit(id)
      {
        var url = "<?php echo base_url();?>"+"edit_city";
        $.ajax({
            type:'POST',
            url: url,
            dataType:"html",
            data:{'city_id':id,"<?php echo $this->security->get_csrf_token_name();?>":"<?php echo $this->security->get_csrf_hash();?>"},
