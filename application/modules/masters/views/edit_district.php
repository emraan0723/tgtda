...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-header modal-colored-header bg-info">
            <h4 class="modal-title text-white" id="info-header-modalLabel">Edit District</h4>
            <button type="button" class="close ml-auto" data-dismiss="modal" aria-hidden="true">×</button>
        </div>
                
            <div class="modal-body">
                     <form id="frm_state_create_id" class="form-material mt-5 needs-validation" method="post" onsubmit="return  districtValidationForm('edit');">
                         <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">
                         <input type="hidden" name="district_id" value="<?php echo isset($getdata['district_id']) ? $this->encryption->encrypt($getdata['district_id']) : '';?>">
                            <div class="row">
                                 ...
                                 <div class="col-sm-12 col-lg-3">
                                    <div class="form-group ">
                                        <label>Select State <span class="text-danger">*</span></label>
                                            <select class="form-control statelist" id="state_id_2" name="state_id">
                                                 <option value=""></option>
                                               <?php
                                ...
                                <div class="col-sm-12 col-lg-3">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" maxlength="100"  value="<?php echo isset($getdata['district_name']) ? $getdata['district_name'] : '';?>" name="district_name" id="district_name_id_2"  class="form-control form-control-line alpha_s"> 
                                        <div class="valid-feedback" style="color: red">
                                      </div>
                                ...
                                <div class="col-sm-12 col-lg-2">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" maxlength="5"  value="<?php echo isset($getdata['district_code']) ? $getdata['district_code'] : '';?>" name="district_code" id="district_code_id_2"  class="form-control form-control-line alpha"> 
                                        <div class="valid-feedback" style="color: red">
                                      </div>
