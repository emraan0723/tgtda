                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card card-body">
                            <h6 class="card-title" style="margin-bottom: -27px;">Add State</h6>
                            <!-- Row -->

                            <?php //echo validation_errors(); ?>

                           <form id="frm_state_create_id" class="form-material mt-5 needs-validation" method="post" onsubmit="return  stateValidationForm('create');">
                            ...
                            <div class="row">
                                 <div class="col-sm-12 col-lg-3">
                                    <div class="form-group ">
                                        <label>Select Country <span class="text-danger">*</span></label>
                                            <select class="form-control" id="country_id_1" name="country_id">
                                                <option value=""></option>
                                                <?php
                                ...
                                <div class="col-sm-12 col-lg-4">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" maxlength="100" name="state_name" id="state_name_id_1"  class="form-control form-control-line alpha_s"> 
                                        <div class="valid-feedback" style="color: red">
                                      </div>
                                ...
                                <div class="col-sm-12 col-lg-2">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" maxlength="5" name="state_code" id="state_code_id_1"  class="form-control form-control-line alpha"> 
                                        <div class="valid-feedback" style="color: red">
                                      </div>
...
$(document).ready(function() {
      var url = "<?php echo base_url();?>"+"state_datatable";
    //datatables
...
<script>
     function stateEdit(id)
      {
        var url = "<?php echo base_url();?>"+"edit_state";
        $.ajax({
            type:'POST',
            url: url,
            dataType:"html",
            data:{'state_id':id,"<?php echo $this->security->get_csrf_token_name();?>":"<?php echo $this->security->get_csrf_hash();?>"
},
