...
<body>
        ...
        if(isset($_SESSION['tupp_source']) && $_SESSION['tupp_source'] ='admin' && isset($_SESSION['tupp_filename']) && $_SESSION['tupp_filename'] !='')
        {
            $imagehtml =base_url().'images/default_pic.png';
           // $imagehtml =isset($_SESSION['tupp_filename']) && $_SESSION['tupp_filename'] !='' ? base_url().'profile_images/admin/'.$_SESSION['tupp_filename']:base_url().'images/default_pic.png';
                        ...
                        <li class="nav-item dropdown ">
                            ...
                            <a class="nav-link dropdown-toggle waves-effect waves-dark " href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >
                                <img src="<?php echo $imagehtml; ?>" alt="user" width="30" class="profile-pic rounded-circle" />
                                 <p style="margin-top: -47px;margin-left: -24px;font-size: 13px;"><?php echo isset($_SESSION['admin_name']) ? ucwords(strtolower($_SESSION['admin_name'])) :'';  ?>
                                    ...
                                    <li>
                                        <div class="dw-user-box p-3 d-flex">
                                            ...
                                            <div class="u-text ml-2">
                                                <h4 class="mb-0"><?php echo isset($_SESSION['user_name']) ? ucwords(strtolower($_SESSION['user_name'])) :'';  ?></h4>
                                                <p class="text-muted mb-1 font-14"><?php echo isset($_SESSION['user_mail']) ? strtolower($_SESSION['user_mail']) :'';  ?></p>
                                                <a href="<?php echo base_url().'user_profile'; ?>" class="btn btn-rounded btn-danger btn-sm text-white d-inline-block">View
                                                    Profile</a>
                                            </div>
                                        </div>
                                    </li>
                                    <li role="separator" class="dropdown-divider"></li>
                                    <li class="user-list"><a class="px-3 py-2" href="<?php echo base_url().'' ?>login/logout"><i class="fa fa-power-off"></i> Logout</a></li>
                                </ul>
                            </div>
                        </li>
                        <!-- ============================================================== -->
