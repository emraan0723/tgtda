...
class Ajax_pagination{
	...
	function create_links(){
		...
		if ($num_pages == 1){
            ...
            $info = '<div class="hide_pagination">Showing : <span class="tot_rows">' . $this->total_rows.'</span></div>';
			return $info;
		}
		//$this->uri_segment=2;
		...
		if ($this->show_count){
			...
			$info .= ' of <span class="tot_rows">' . $this->total_rows . ' </span>| ';
